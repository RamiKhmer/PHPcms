...
<div class="container">
    <h1 class="page-header">
        Welcome to Mean Chey Univertsity
    </h1>
    <!-- <center><img class="img-responsive" src="images/laptop-analytics-2.png" alt="" width="60%"></center> -->
</div>
        ...
        <div class="col-md-8">
            ...
            while ($rows = mysqli_fetch_assoc($selectAllPost)) {
                ...
                if ($post_status !== 'published') {
                    echo "<h2 class='text-center' style='color:red' >Not Availeble.</h2>";
                } else {
